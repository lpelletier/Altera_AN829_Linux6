...
// Each loop contains 2 runs to test wrap around of last descriptor pointer
        printf("Read Time               : %ld s and %ld us\n", ((struct dma_status *)buf)->read_time.tv_sec, ((struct dma_status *)buf)->read_time.tv_nsec / 1000);
        printf("Read Throughput         : %f GB/S\n", (((struct dma_status *)buf)->length_transfer*0.954)/((((struct dma_status *)buf)->read_time.tv_nsec / 1000.0) + 1000000*((struct dma_status *)buf)->read_time.tv_sec ));
        printf("Write Time              : %ld s and %ld us\n", ((struct dma_status *)buf)->write_time.tv_sec, ((struct dma_status *)buf)->write_time.tv_nsec / 1000);
        printf("Write Throughput        : %f GB/S\n", (((struct dma_status *)buf)->length_transfer*0.954)/((((struct dma_status *)buf)->write_time.tv_nsec / 1000.0) + 1000000*((struct dma_status *)buf)->write_time.tv_sec ));
        printf("Simultaneous Time       : %ld s and %ld us\n", ((struct dma_status *)buf)->simul_time.tv_sec, ((struct dma_status *)buf)->simul_time.tv_nsec / 1000);
        printf("Simultaneous Throughput : %f GB/S\n", (((struct dma_status *)buf)->length_transfer*0.954*2)/((((struct dma_status *)buf)->simul_time.tv_nsec / 1000.0) + 1000000*((struct dma_status *)buf)->simul_time.tv_sec ));
